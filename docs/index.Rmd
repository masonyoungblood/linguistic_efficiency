...
#do not allow flextable header row to wrap
flextable::set_flextable_defaults(font.family = "Garamond", font.size = 10, padding.top = 1, padding.bottom = 1)
```
