...
Automated clustering methods carry a risk of duration-bias&mdash;variation may be more detectable in longer syllables [@gilman_etal23]. <!--This risk should be minimized by the use of dynamic time warping and dynamic tree cut, and-->A replication of Zipf's law of abbreviation with manually-classified syllables [@Mann2020], as well as an exploratory assessment of duration bias in the automated clustering algorithm, can be found in [Supplementary Information](https://masonyoungblood.github.io/linguistic_efficiency/supplement/supplement.html).
...
The data and code for this study are available on Zenodo (https://doi.org/10.5281/zenodo.10689808).
