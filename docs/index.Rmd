...
A long-standing critique of Zipf's laws is that they may be statistical artifacts of other processes, starting with Miller's observation that randomly typing on keyboards can produce similar patterns [@miller57]. Random typing accounts are not realistic causal descriptions of how communication systems emerge, though, and there are empirical reasons to doubt that they undermine efficiency accounts [@piantadosi14]. Randomly-generated texts produce rank-frequency distributions that differ from those in real corpora [@ferrer-i-cancho_elvevag10], and random typing models are not truly neutral---they can be mathematically reframed as optimizing for efficiency [@ferrer-i-cancho_etal22]. Most importantly, there is direct experimental evidence that Zipfian abbreviation emerges from pressure for efficient communication [@kanwal_etal17a]. See @semple_etal22, @piantadosi14, and @kanwal17 for more complete summaries of this debate.
